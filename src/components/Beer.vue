<template>
    <div>
            ...
            <div class="beer-item current">
                ...
                <div class="food-wrapper">
                    <div class="food-title-wrapper"
                        ...
                        <div :class="`arrow-dropdown ${showFood ? 'arrow-dropdown-open' : 'arrow-dropdown'}`"></div>
                    </div>
                    <transition name="animated" enter-active-class="animated lightSpeedIn" leave-active-class="animated lightSpeedOut">
                        <div v-if="showFood">
                            <p :key="index" 
        ...
        <div v-else class="nothing-found__wrapper">
            <div class="nothing-found__img-wrapper">
                <img src="../assets/img/giphy.gif" alt="nothing" class="nothing-found">
            </div>
            <h3>Sorry, nothing found for your request</h3>
        </div>
    </div>
</template>
